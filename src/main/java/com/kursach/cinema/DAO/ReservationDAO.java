...
public class ReservationDAO {
    ...
    public void addReservation(Reservation reservation) {
        jdbcTemplate.update("INSERT INTO reservation (screaning_id, employee_id, reservation_type, paid, seat_reservation_id, active) values (?, ?, ?, ?, ?, ?)",
                reservation.getScreeningID(), reservation.getEmployeeID(), reservation.getReservationType(), reservation.getPaid(), reservation.getSeatReservationID(), reservation.isActive());
    }
...
class ReservationRowMapper implements RowMapper<Reservation>{
    ...
    public Reservation mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        reservation.setScreeningID(rs.getLong("screaning_id"));
        reservation.setReservationType(rs.getString("reservation_type"));
        reservation.setPaid(rs.getDouble("paid"));
        reservation.setSeatReservationID(rs.getLong("seat_reservation_id"));
        reservation.setActive(rs.getBoolean("active"));
        reservation.setEmployeeID(rs.getLong("employee_id"));
